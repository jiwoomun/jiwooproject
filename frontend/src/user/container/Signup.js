...
const SignUp = () => {
  ...
  <div className="container">
    ...
    <input type="text" placeholder="Enter ID" onChange={handleChange} name="username" value={username} required/>

    <label for="password"><b>Password</b></label>
    <input type="password" placeholder="Enter Password" onChange={handleChange} name="password" value={password} required/>
    
    <label for="name"><b>Name</b></label>
    <input type="text" placeholder="Enter Your name" onChange={handleChange} name="name" value={name} required/>

    <label for="email"><b>Email</b></label>
    <input type="text" placeholder="Enter Your Email" onChange={handleChange} name="email" value={email} required/>
