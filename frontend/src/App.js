...
import { MemberDetail, MemberListComponent, MemberLoginForm, MemberModifyForm, MemberRegister } from 'member'
...
const App = () => {
  return (<div>
    <Router>
        ...
        <Route exact path='/member-list' component={ MemberListComponent}/>
        <Route exact path='/member-login' component={MemberLoginForm}/>        
        <Route exact path='/member-modify' component={MemberModifyForm}/>
